import { TRIANGULATION } from 'App/utils';
...
export class FacePaint {
  ...
  _addCamera() {
    this._camera = new THREE.OrthographicCamera(this._halfW, -this._halfW, -this._halfH, this._halfH, -500, 500);
  ...
  constructor({ ctx, textureFilePath, w, h }) {
